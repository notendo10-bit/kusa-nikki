...
export default function Shoot() {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', background: '#fff8ee', fontFamily: 'sans-serif' }}>
      ...
      <button disabled={!photo} style={{ margin: '16px 16px 0', padding: 15, background: photo ? '#5a9e22' : '#c8c8c8', color: '#fff', border: 'none', borderRadius: 20, fontSize: 16, fontWeight: 'bold', cursor: photo ? 'pointer' : 'default', borderBottom: photo ? '4px solid #3b6d11' : 'none' }}>
        🔍 AIに草を聞く！
      </button>
    </div>
  );
